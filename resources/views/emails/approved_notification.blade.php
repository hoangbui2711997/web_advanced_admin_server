...
@section('content')
    <div style="margin-bottom: 20px">
        ...
        <div style="margin-bottom: 35px;">
            <div style="font-size: 14px;">
                <ul style="padding-left: 17px">
                    <li>@lang('emails.approved_notification.text2', [], $locale) : {{ strtoupper($currency) }}</li>
        ...
        <p style="margin-bottom:20px; margin-top: 0">@lang('emails.approved_notification.text7_1', [], $locale)</p>
        <p style="margin-bottom:0; margin-top: 0">@lang('emails.approved_notification.text8', [], $locale)</p>
