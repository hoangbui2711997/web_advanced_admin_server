  ...
  <div class="login-page-wrap">
    <div class="login-page">
      <div class="wrap-content">
        <h2 style="color: white; margin-bottom: 40px; opacity: 0.9;">Register Page</h2>
        <div class="login-form">
          ...
          <div :class="errors.has('password_confirmation') || errors.first('email') === $t('_auth.failed') ? 'active-warning' : ''" class="form-group">
            <input
              v-validate.disable="'required'"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      register (params) {
        return rf.getRequest('AdminRequest').register(params).then(() => {
